...
-- ─────────────────────────────────────────────────────────────────────────────
-- v12: eliminados tel_oficina, direccion, tipo_contrato, estatus,
...
-- ─────────────────────────────────────────────────────────────────────────────
-- v12: eliminados genero, tel_casa, direccion
-- ─────────────────────────────────────────────────────────────────────────────
CREATE TABLE `alumno` (
...
-- ─────────────────────────────────────────────────────────────────────────────
-- v12: eliminados horas_teoricas, horas_practicas
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- v12: eliminado campo activo — el catálogo es global, todas visibles
-- ─────────────────────────────────────────────────────────────────────────────
...
--  v12  maestro                  → eliminados 9 campos no usados
--  v12  alumno                   → eliminados genero, tel_casa, direccion
--  v12  materia                  → eliminados horas_teoricas, horas_practicas
--  v12  reticula                 → eliminado creditos
--  v12  tipo_actividad           → eliminado activo
--  v12  notificacion             → tabla eliminada por completo
-- ============================================================
