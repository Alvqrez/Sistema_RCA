...
async function cargarMaestros() {
  ...
  // ← ANTES: document.querySelector("#tablaMaestros tbody") — INCORRECTO
  // #tablaMaestros ES el tbody, no tiene un tbody hijo
...
document
  ...
  .addEventListener("submit", async function (e) {
    ...
    const maestro = {
      ...
      correo_institucional: document.getElementById("correoInstitucional")
        .value,
